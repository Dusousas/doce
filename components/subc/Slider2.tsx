        ...
        <>
            <section className='slider1 maxW relative'>
                ...
                <div className='relative px-2 h-full flex justify-center flex-col items-center lg:px-8 z-10'>
                    <h1 className='text-7xl uppercase tracking-wider text-center text-white'>Slide 2</h1>
                    <h5 className='mt-2 text-lg font-light text-center text-white'>Texto 2</h5>
                </div>
            </section>
        </>
    );
